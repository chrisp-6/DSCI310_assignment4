...
The R programming language (R Core Team, 2019) and the following R packages were used to perform the analysis: knitr (Xie 2014), tidyverse (Wickham 2017), and bookdown (Xie 2016). *Note: this report is adapted from @ttimbers-horses .*

# Results

```{r, echo=FALSE, fig.cap= "Horse populations for all provinces in Canada from 1906 - 1972"}
...
```{r, message=FALSE, echo = FALSE, fig.cap = "Table of Horse population standard deviations"}
...
```{r, echo=FALSE, fig.cap= 'Horse populations for the province with the largest standard deviation'}
